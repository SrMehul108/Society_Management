...
const OtherPaymentPopup = ({ isOpen, onClose }) => {
    ...
    const handlePayNow = () => {
        if (selectedPaymentMethod === 'cash') {
            // Apply "Cash Payment" logic (e.g., immediately close the popup, etc.)
            console.log('Proceeding with Cash Payment');
            // onClose(); // Close the popup without opening the form
        } else {
            // Open the payment form popup for other methods
            handleOpenPopup();
        }
    };
            ...
            <div className="bg-white rounded-lg p-6 w-full max-w-md md:max-w-lg lg:max-w-xl">
                ...
                <div className="flex justify-between mt-6 gap-2">
                    ...
                    <div className='w-1/2'>
                        ...
                        {/* Only show the payment form popup if the payment method is not cash */}
